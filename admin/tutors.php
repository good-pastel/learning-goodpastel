...
<p>
    <a href="tutors_input.php">
        <input type="button" class="btn btn-primary" value="Create New Tutors" />
    </a>
</p>
<?php
if ($succeed) {
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="tutors.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Are you sure you want to delete this file?')">
